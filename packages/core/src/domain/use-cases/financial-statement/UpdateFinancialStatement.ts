...
export default class UpdateFinancialStatement extends UseCase<[FinancialStatement, boolean]> {
  ...
  protected build(): Observable<[FinancialStatement, boolean]> {
    return this.repository.updateFinancialStatement(this.financialStatement as FinancialStatement);
  }
