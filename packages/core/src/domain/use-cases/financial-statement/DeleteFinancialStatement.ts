...
export default class DeleteFinancialStatement extends UseCase<[FinancialStatement, boolean]> {
  ...
  protected build(): Observable<[FinancialStatement, boolean]> {
    return this.repository.deleteFinancialStatement(this.financialStatement as FinancialStatement);
  }
