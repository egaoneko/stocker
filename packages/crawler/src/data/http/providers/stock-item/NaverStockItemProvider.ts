...
import NaverStockItemMapper from '../../mappers/stock-item/NaverStockItemMapper';
      ...
      .pipe(
        ...
        map((html: string): StockItem[] => {
          ...
          $bodyList.each((i, element): any => {
            const stockItem: StockItem | null = new NaverStockItemMapper().toEntity($, element, NaverKOSPI);
